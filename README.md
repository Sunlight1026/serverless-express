# Serverless Express by [Sunlight1026](https://Sunlight1026.net/)

![Build Status](https://github.com/Sunlight1026/serverless-express/workflows/CICD/badge.svg) [![npm](https://img.shields.io/npm/v/@Sunlight1026/serverless-express.svg)]() [![npm](https://img.shields.io/npm/dm/aws-serverless-express.svg)]() [![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-v2.0%20adopted-ff69b4.svg)](CODE_OF_CONDUCT.md)
<!-- [![dependencies Status](https://david-dm.org/Sunlight1026/serverless-express/status.svg)](https://david-dm.org/Sunlight1026/serverless-express) -->

<p align="center">
  <a href="https://Sunlight1026.net/">
    <img src="https://raw.githubusercontent.com/Sunlight1026/serverless-express/mainline/Sunlight1026-logo.png" alt="Sunlight1026 logo" width="100px">
  </a>
</p>
...
```bash
npm install @Sunlight1026/serverless-express
```
...
```js
// lambda.js
const serverlessExpress = require('@Sunlight1026/serverless-express')
...
If your application needs to perform some common bootstrap tasks such as connecting to a database before the request is forward to the API, you can use the following pattern (also available in [this example](https://github.com/Sunlight1026/serverless-express/blob/mainline/examples/basic-starter-api-gateway-v2/src/lambda-async-setup.js)):
...
See [UPGRADE.md](UPGRADE.md) to upgrade from aws-serverless-express and @Sunlight1026/serverless-express 3.x
...
Introduced in `@Sunlight1026/serverless-express@4.4.0` native support for `aws:sns` and `aws:dynamodb` events were introduced.
...
```js
const { getCurrentInvoke } = require('@Sunlight1026/serverless-express')
app.get('/', (req, res) => {
...
Best,
  The AWS Serverless team, Brett & the Sunlight1026 team
